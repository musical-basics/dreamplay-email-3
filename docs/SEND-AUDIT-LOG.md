...
- **Post-audit change:** per Lionel, the 2 inactive real buyers (eripianostudio@gmail.com, jaydeireland@gmail.com) were reactivated (status active) and added to the locked list, since this is an ops email all purchasers should receive. **Final audience: 67.** 2 bounced addresses remain excluded (undeliverable).
- **Outcome:** scheduled 2026-06-18T09:00:00Z to 67 recipients; outcome to be recorded after fire.
